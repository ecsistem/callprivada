...
// Cada entrada vira um input em "Textos avançados"; valor vazio usa o padrão.
const COMMON_PAY_TEXTS = [
...
const EXTRA_TEXT_FIELDS: Partial<Record<EventType, { key: string; label: string; def: string }[]>> = {
  countdown: [
